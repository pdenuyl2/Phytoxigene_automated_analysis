...
ggsave(std_curve_plot_total, height = 5, width = 5, path = "output/total", filename = "standard_curve_total.pdf", device = "pdf", create.dir = TRUE)
...
ggsave(std_curve_plot_toxin, height = 5, width = 5, path = "output/mcye", filename = "standard_curve_mcye.pdf", device = "pdf", create.dir = TRUE)
...
ggsave(std_curve_plot_sxta, height = 5, width = 5, path = "output/sxta", filename = "standard_curve_sxta.pdf", device = "pdf", create.dir = TRUE)
...
#2.2.1 - added create.dir = TRUE to ggsave to prevent initial errors when running code off github
