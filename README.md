...
| **Test 10** | Identify reactions below detection limit (BDL) of assay | Checks if reaction is $\ge 45$ copies/reaction |
| **Test 11** | Identify reactions below quantification limit of assay (BQL) | Checks if reaction is $\ge 100$ copies/reaction |
